...
export function IntroCampaignCheckoutReview({
  ...
  const checkoutDisabled = busy || Boolean(eligibilityNote) || !email.includes("@");
  ...
  return (
    <section id="intro-checkout-step" className="buy-checkout-section">
      ...
      <p className="buy-checkout-section__sub">
        ...
        homeowners with {serviceLineLabel(INTRO_CAMPAIGN.serviceLine)}. One introductory purchase per email.
      </p>
      ...
      <div className="buy-checkout-grid">
        <div className="buy-checkout-panel buy-checkout-panel--order">
          ...
          {eligibilityNote ? <p className="intro-checkout__warn">{eligibilityNote}</p> : null}
