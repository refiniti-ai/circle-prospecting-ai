...
async function main() {
    ...
    console.log("7. Production: same-domain = leave VITE_API_BASE_URL unset; deploy API to Cloud Run + firebase.json /api rewrite; or set VITE_API_BASE_URL to a public API URL\n");
}
main().catch((e) => {
    console.error(e);
    process.exit(1);
